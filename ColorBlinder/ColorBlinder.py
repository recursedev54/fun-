...
def update_colors():
    ...
    original_color_label.config(bg=original_hex)
    protan_color_label.config(bg=protan_hex)
    deuteran_color_label.config(bg=deuteran_hex)
    tritan_color_label.config(bg=tritan_hex)
