...
def adjust_color_for_clickability(rgb_color):
    ...
    elif rgb_color[0] < 50 and rgb_color[1] > 200 and rgb_color[2] > 200:
        # Swap blue and green components
        return (rgb_color[0], rgb_color[2], rgb_color[1])
    else:
        return rgb_color
...
def tritan_simulation(hex_color):
    ...
    ratio = [0, 0]
    if rgb_color[2] != 0:
        ratio[0] = rgb_color[2] / 255.0
    if rgb_color[1] != 255:
        ratio[1] = (255 - rgb_color[1]) / 255.0

    # Adjust blue and green components
    new_color1 = (rgb_color[0], int(128 * ratio[1]), int(128 * ratio[0]))
    new_color2 = (rgb_color[0], int(128 - (128 * ratio[0])), rgb_color[2])
...
def simulate_clicked_color(hex_color):
    """Callback function to simulate Tritanopia based on clicked color."""
