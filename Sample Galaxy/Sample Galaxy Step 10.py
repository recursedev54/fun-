...
class SampleGalaxyApp:
    ...
    def draw_spiral_galaxy(self, angle_offset):
        ...
        arm_thickness = 10  # Thickness of the arms
        ...
        for arm in range(num_arms):
            for i in range(num_stars_per_arm):
                ...
                distance_from_center = arm_length * (1 + i / num_stars_per_arm) - 225
                ...
                # Draw the star
                size = random.randint(1, arm_thickness)
    ...
    def animate_galaxy(self):
        ...
        self.angle_offset += 0.04  # Increment the angle offset for rotation
